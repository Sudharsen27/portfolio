    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-4 py-20">
        <div className="relative max-w-[700px] pl-0 md:pl-4">
          ...
          <p
            className="animate-fade-in text-xs font-semibold uppercase tracking-[0.14em] text-blue-400 sm:text-sm sm:tracking-[0.16em]"
          ...
          <p
            className="mt-5 max-w-[650px] animate-fade-in text-base leading-relaxed text-zinc-400 sm:mt-6 sm:text-lg sm:leading-8"
            style={{
          ...
          {heroData.highlightBadges && heroData.highlightBadges.length > 0 && (
            <ul
              className="mt-6 flex animate-fade-in flex-wrap gap-2 sm:mt-7"
              style={{
            ...
            >
              {heroData.highlightBadges.map((badge) => (
                <li
                  key={badge}
