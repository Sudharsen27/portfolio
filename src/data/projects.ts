...
export const projectsData: Project[] = [
  {
    ...
    description:
      "Built a full-stack MDM Data Governance Platform to manage and validate data quality. Includes quarantine system, rules engine, dynamic validation, ETL pipeline simulation, and analytics dashboard using a Python (FastAPI) backend with PostgreSQL and Snowflake.",
    tags: [
      "Tailwind CSS",
      "Python",
      "FastAPI",
  ...
  },
  {
    ...
    tags: ["Next.js", "Node.js", "Express", "MongoDB", "JWT", "Razorpay"],
  ...
  },
  {
    ...
    tags: ["Next.js", "Cloudflare Pages", "SEO", "Responsive"],
