...
export const featuredProjects: Project[] = [
  {
    ...
    description:
      "Enterprise Restaurant Management Platform built using React, FastAPI, PostgreSQL, Docker and AWS Cloud Infrastructure.",
    problem:
    ...
    keyFeatures: [
      "Multi-location restaurant management with RBAC and executive dashboards",
      "Inventory, procurement, supplier management, and billing foundation",
      "Cloud-native architecture with Docker and AWS Infrastructure as Code",
      "Public live demonstration with enterprise AWS deployment architecture preserved",
    ],
    challenges: [
      "Designing scalable enterprise architecture and reusable FastAPI modules",
      "JWT authentication, PostgreSQL schema design, and Redis integration",
      "AWS Infrastructure as Code, IAM, networking, and cloud cost optimization",
    ],
    businessImpact:
      "Unifies restaurant operations into one enterprise platform with cloud-native architecture and a production-ready public demonstration.",
    tags: [
      "Production Ready",
      "Enterprise",
      "AWS",
    ...
    href: "https://restaurant-resource-planning-system.vercel.app",
    liveStatusLabel: "Production Ready",
